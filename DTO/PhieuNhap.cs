...
namespace QLBanPiano.DTO
{
    public class PhieuNhap
    {
        ...
        public PhieuNhap(int id, int id_nhanvien, DateTime thoiGian,List<ChiTietPhieuNhap> phieuNhapList/*, List<NhacCu> dsNhacCu, List<long> donGiaLucBan, List<int> soLuong*/)
        {
            Id = id;
